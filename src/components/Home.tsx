...
import { Github, Linkedin, Mail, ExternalLink, Sparkles, LucideIcon, MessageCircle } from "lucide-react"
  ...
  <Link href={href}>
    <button className="group relative w-40">
      ...
      <div className="relative h-11 bg-[#030014] backdrop-blur-xl rounded-lg border border-white/10 leading-none overflow-hidden">
        <div className="absolute inset-0 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 bg-linear-to-r from-[#4f52c9]/20 to-[#8644c5]/20"></div>
        <span className="absolute inset-0 flex items-center justify-center gap-2 text-sm group-hover:gap-3 transition-all duration-300">
          <span className="bg-linear-to-r from-gray-200 to-white bg-clip-text text-transparent font-medium z-10">
            {text}
          </span>
...
const SocialLink = memo(({ icon: Icon, link }: { icon: LucideIcon; link: string }) => (
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="800">
                  ...
                  <span className="w-0.75 h-6 bg-linear-to-t from-[#6366f1] to-[#a855f7] ml-1 animate-blink"></span>
                </div>
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-150 xl:h-187.5 relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                ...
                <div className={`absolute inset-0 pointer-events-none transition-all duration-700 ${
                  ...
                  <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-100 h-100 bg-linear-to-br from-indigo-500/10 to-purple-500/10 blur-3xl animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] transition-all duration-700 ${
