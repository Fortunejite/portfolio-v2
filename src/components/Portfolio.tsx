...
const techStacks = [
  ...
  { icon: "tailwind-css.svg", language: "Tailwind CSS" },
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-12 bg-[#030014] overflow-hidden" id="Portfolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-linear-to-r from-[#6366f1] to-[#a855f7]">
          <span style={{
            color: '#6366f1',
